                    ...
                    <div class="card-body">
                        <div class="profile-card">
                            ...
                            <div class="profile-card__txt">
                                <h3 class="profile-card__title">{{ __($reviewer->name) }}</h3>
                                <span class="badge badge--secondary">@lang('Authorized Reviewer')</span>
                            </div>
                ...
                <div class="tab-content">
                            ...
                            <div class="card-body">
                                <form class="row g-lg-4 g-3" action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <input type="text" class="form--control" name="name" value="{{ $reviewer->name }}" required>
                                    </div>
                                    <div class="col-12">
                                        <label class="form--label required">@lang('Username')</label>
                                        <input type="text" class="form--control" value="{{ $reviewer->username }}" readonly>
                                    </div>
                                    <div class="col-12">
                                        <label class="form--label required">@lang('Email')</label>
                                        <input type="email" class="form--control" value="{{ $reviewer->email }}" readonly>
                                    </div>
                                    <div class="col-12">
                                        <label class="form--label required">@lang('Contact')</label>
                                        <input type="text" class="form--control" name="contact" value="{{ $reviewer->contact }}" required>
                                    </div>
                                    <div class="col-12">
                                        <label class="form--label required">@lang('Address')</label>
                                        <textarea class="form--control" name="address" required>{{ $reviewer->address }}</textarea>
                                    </div>
                                    <div class="col-12">
                    ...
                    <div class="tab-pane fade" id="nav-password" role="tabpanel" aria-labelledby="nav-password-tab" tabindex="0">
                        <div class="custom--card">
                            ...
                            <div class="card-body">
                                <form class="row g-lg-4 g-3" action="{{ route('reviewer.password.update') }}" method="POST">
                                    @csrf

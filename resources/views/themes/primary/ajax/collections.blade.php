            ...
            <div class="col-xl-3 col-lg-4 col-sm-6 col-xsm-6">
                <div class="collection__card">
                    ...
                    <div class="collection__card__txt">
                        ...
                        <span class="collection__card__info">@lang('Created by') <a href="{{ $collection->user->author_status == ManageStatus::AUTHOR_APPROVED ? route('author.profile', [encrypt($collection->user_id), slug($collection->user->author_name)]) : route('member.user.profile', [encrypt($collection->user_id), slug($collection->user->username)]) }}">{{ $collection->user->author_status == ManageStatus::AUTHOR_APPROVED ? __($collection->user->author_name) : __($collection->user->username) }}</a></span>
                        @if (count($tags))
...
@if ($collections->hasPages())
    <div class="search-result__pagination d-flex allCollectionPagination">
        <div>
        ...
        <div class="search-result__pagination__input">
            <form class="allCollectionPaginationForm">

    ...
    <div class="row g-4 justify-content-lg-between justify-content-center align-items-center">
        <div class="col-lg-5 col-md-7 col-sm-8 col-xsm-8">
            <div class="deposit__thumb">
                <img src="{{ getImage($activeThemeTrue . 'images/site/deposit/' . $siteData?->data_info?->image, '725x590') }}" alt="image">
            </div>
        </div>
        <div class="col-lg-6 col-md-10">
            <div class="custom--card">
                <div class="card-header">
                    <h3 class="title">@lang('Deposit Methods')</h3>
                </div>
                <div class="card-body payment-container">

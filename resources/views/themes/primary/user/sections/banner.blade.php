@php
    ...
    $socialAccounts   = App\Models\SocialProfile::active()->where('user_id', $user->id)->latest()->limit(4)->get();
@endphp

<div class="user-profile__banner dashboard__banner bg-img" id="coverImageContainer" data-background-image="{{ $user->cover_image ? getImage(getFilePath('userCover') . '/' . $user->cover_image, getFileSize('userCover')) : getImage($activeThemeTrue . 'images/site/default_user_cover/' . $defaultUserCover?->data_info?->image, '1920x500') }}">
        ...
        <div class="row g-4 align-items-center">
            <div class="col-lg-4">
                <div class="user-profile__banner__profile">
                    <div class="user-profile__banner__profile__img">
                        <img id="profileImage" src="{{ getImage(getFilePath('userProfile') . '/' . $user->image, getFileSize('userCover'), true) }}" alt="Phinex">
            ...
            <div class="col-lg-8">
                <div class="user-profile__banner__info">
                    ...
                    @elseif ($user->author_status == ManageStatus::NO)

...
@section('content')
    <section class="account">
        <div class="account__form">
            <div class="account__form__bg bg-img" data-background-image="{{ getImage($activeThemeTrue . 'images/site/mobile_confirm/' . $siteData?->data_info?->image, '1920x1080') }}"></div>
        ...
        <div class="account__img bg-img" data-background-image="{{ getImage($activeThemeTrue . 'images/site/mobile_confirm/' . $siteData?->data_info?->bg_image, '1920x1280') }}"></div>
    </section>
@endsection

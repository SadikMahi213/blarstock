...
@section('content')
    <section class="account">
        <div class="account__form">
            <div class="account__form__bg bg-img" data-background-image="{{ getImage($activeThemeTrue . 'images/site/code_verification/' . $siteData?->data_info?->image, '1920x1080') }}"></div>
            <div class="account__form__container">
                ...
                <form method="POST" class="verification-code-form">
                    @csrf
                    <div class="row">
                        <div class="mb-4">
        ...
        <div class="account__img bg-img" data-background-image="{{ getImage($activeThemeTrue . 'images/site/code_verification/' . $siteData?->data_info?->bg_image, '1920x1280') }}"></div>
    </section>
@endsection

                        ...
                        <div class="card-body">
                            <div class="row g-lg-4 g-3">
                                ...
                                <div class="col-12">
                                    <div class="row align-items-center gy-2">
                                        <div class="col-xxl-3">
                                            <label class="col-form--label required">@lang('Subheading')</label>
                                        </div>
                                        <div class="col-xxl-9">
                                            <input type="text" class="form--control" name="subheading" value="{{ $maintenance?->data_info?->subheading }}" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-12">

...
class ProcessController extends Controller
{
    ...
    public function ipn(Request $request)
    {
        ...
        $data = array(
            ...
            "capture"               => true,
            "customer"              => array(
                "email" => $deposit->user_id ? $deposit->user?->email : $deposit->donation_sender?->email ?? '',
                "name"  => $deposit->user_id ? $deposit->user?->fullname : $deposit->donation_sender?->name ?? '',
                "phone" => array(
                    "number" => $deposit->user_id ? $deposit->user?->mobile : $deposit->donation_sender?->mobile ?? '',
                ),
            )
        );

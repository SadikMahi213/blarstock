...
class ProcessController extends Controller
{
    ...
    public static function process($deposit)
    {
        ...
        $send['customer_email'] = auth()->user() ? auth()->user()->email : $deposit->donation_sender->email;
        $send['amount']         = round($deposit->final_amo,2);
        $send['customer_phone'] = auth()->user() ? auth()->user()->mobile : $deposit->donation_sender->mobile;
